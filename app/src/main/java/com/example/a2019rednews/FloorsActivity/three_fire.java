...
public class three_fire extends AppCompatActivity {
    bluetoothservice bs;
    boolean gas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_three_fire);
    ...
    public void buttonClick(View v) {
        ...
        final ImageView[] exitArray = {(ImageView) findViewById(R.id.exit1), (ImageView) findViewById(R.id.exit2),
